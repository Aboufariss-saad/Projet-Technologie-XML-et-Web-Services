...
public class ObjectFactory {
    ...
    private final static QName _Exception_QNAME = new QName("http://Metier/", "Exception");
    private final static QName _GetReleve_QNAME = new QName("http://Metier/", "getReleve");
    private final static QName _GetReleveResponse_QNAME = new QName("http://Metier/", "getReleveResponse");
    private final static QName _Releve_QNAME = new QName("http://Metier/", "releve");
     ...
     */
    @XmlElementDecl(namespace = "http://Metier/", name = "Exception")
     ...
     */
    @XmlElementDecl(namespace = "http://Metier/", name = "getReleve")
     ...
     */
    @XmlElementDecl(namespace = "http://Metier/", name = "getReleveResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://Metier/", name = "releve")
